...
namespace Kos
{
	...
	*/
	...
	/*
	*/
	Kos::KRender::QueueFamilyIndices KRender::FindQueueFamilies(VkPhysicalDevice _VkPhysicalDevice)
	{
	...
	/*
	*/
	Kos::KRender::QueueFamilyIndices KRender::GetQueueFamilyIndices(VkPhysicalDevice _VkPhysicalDevice)
	{
	...
	*/
	...
	/*
	*/
	Kos::KRender::SwapChainSupportDetails KRender::GetSwapChainDetails(VkPhysicalDevice _VkPhysicalDevice)
	{
	...
	*/
	...
	/*
	*/
	void Kos::KRender::CreateLogicalDevice()
	{
